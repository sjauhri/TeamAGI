...
class PickBehaviour(py_trees_ros.actions.ActionClient):
    ...
    def select_arm(self):
        ...
        pose = np.array(([[next_cube.pose.position.x,next_cube.pose.position.y,next_cube.pose.position.z,\
                        next_cube.pose.orientation.x,next_cube.pose.orientation.y,next_cube.pose.orientation.z]]))
    ...
    def get_pick_up_goal(self):
        ...
        console.loginfo("arm:", pick_up_goal.left_right)       
